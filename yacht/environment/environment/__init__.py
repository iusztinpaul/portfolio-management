...
from data.renderers import build_renderer, BaseRenderer
...
class Environment:
    ...
    def __init__(
        ...
        # TODO: Find a more explicit way to add multiple loaders.
    ...
    def renderer(self) -> BaseRenderer:
        # TODO: Move renderer to the level of the environment
        return list(self.loaders.values())[0].renderer
    ...
    def _next_batch(self, data_loader: BaseDataLoader):
        ...
        # FIXME: When backtesting the first `previous_w` is not all in cash position, because we don't start actually at T=0
